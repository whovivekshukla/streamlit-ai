...
def book_appointment(patient_name: str, doctor_name: str, appointment_time: str, appointment_type_id: int, start_time: str, end_time: str, duration_in_minutes: int, note: str, event_title: str, status: str, booking_category: str, override_slots: bool) -> str:
    ...
    headers = {
        'authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InFWMDZzQzkzVS1UNWRIdXhRSWY1TyJ9.eyJuaWNrbmFtZSI6Im1hbmlzaGJhc2FyZ2VrYXIrc3BwIiwibmFtZSI6Im1hbmlzaGJhc2FyZ2VrYXIrc3BwQGF6b2RoYS5jb20iLCJwaWN0dXJlIjoiaHR0cHM6Ly9zLmdyYXZhdGFyLmNvbS9hdmF0YXIvMjhlOWRiYzZjNjNjNzRlOWRlMDA3NjlhZjkxMWY2OTE_.lduWsLy6GU8-PyelRpSHRSnFYp6iey0KysLZxHvc1DihSSMT-c3Ra3osrtbMYXv5DS3n9_kQfWphmVYFNrd1GOYZxSvMpOyEvgadkRNIzcTfXYC4uSekS67FSqs3TUD1U1a7g7ghhz3zWLaB0fk6MBd-rIgPwq-PvhETCwaUCLbIqfLTSweukoN9kpECkhOj2f-Nw5rUJ8HbF7014Be6mFxxuv6lfeP2AKOOzMK13sxvb8s1q9oJXFXUmJod6OZOuzOmUE-yCw5nj4gqQWlYezBpvo-7068yqlxlEbYlHC90tTt0SI-NACSnfEzF4QQy_ZcANkioyNAA-SQa8dmLhw',
